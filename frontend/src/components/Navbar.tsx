    ...
    return (
        ...
        <header className="w-full px-2 sm:px-6 py-4 shadow-lg top-0 z-50">
            <div className="sm:max-w-11/12 xl:max-w-9/12 mx-auto flex items-center justify-between">
                ...
                <Link href="https://tic-tac-toe-online-victorrms.vercel.app/" target="_blank" className="hidden sm:inline text-xl sm:text-2xl lg:text-4xl">
                    <h1 className=''>Tic-Tac-Toe: Online</h1>
                </Link>
